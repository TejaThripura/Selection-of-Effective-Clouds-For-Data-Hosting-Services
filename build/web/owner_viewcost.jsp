...
<body>
    ...
    <li><a href="owner_viewcost.jsp" class="selected">Storage Cost</a></li>
 ...
 <!-- MAIN CONTENT --> 
   ...
   String email = session.getAttribute("email").toString();
    ...
    PreparedStatement ps = con.prepareStatement("select * from owner where email = '"+email+"'");
    ResultSet rs1 = ps.executeQuery();

    %>
    <p><center><font size="5" color="white">View My Files Cost</font></center></p><br/>
    <style>
        th{
            color: #298bff;
        }
