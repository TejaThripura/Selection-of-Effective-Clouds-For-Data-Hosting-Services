...
<body>
    ...
    <li><a href="owner_viewfiles.jsp" class="selected">View Files</a></li>
 ...
 <!-- MAIN CONTENT --> 
   ...
   String email = session.getAttribute("email").toString();
    ...
    PreparedStatement ps = con.prepareStatement("select * from upload where email = '"+email+"'");
    ResultSet rs1 = ps.executeQuery();

    %>
    <p><center><font size="5" color="white">View My Files </font></center></p><br/>
    <style>
        th{
            color: #298bff;
        }
    ...
    <td><textarea style=" width:40"><%=rs1.getString(1)%></textarea></td>
