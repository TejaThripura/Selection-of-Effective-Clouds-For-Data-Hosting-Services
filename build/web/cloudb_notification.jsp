...
<%
	...
	while(rs.next()){
           ...
           <td><a href="cloudb_notification1.jsp?ownername=<%=rs.getString(3)%>&filename=<%=rs.getString(2)%>&data=<%=rs.getString(5).replaceAll("\\+", "%2B")%>"><font color="#0d637d" size="3">Send Notification</font></a> </td>
