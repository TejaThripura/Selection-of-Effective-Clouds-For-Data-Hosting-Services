...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <td><textarea style=" width:40"><%=rs.getString(1)%></textarea></td>
                 <td><%=rs.getString(3)%></td>
                  <td><a href="proxy_viewfiles1.jsp?ownername=<%=rs.getString(4)%>&filename=<%=rs.getString(2)%>&data=<%=rs.getString(1)%>&ownerdate=<%=rs.getString(3)%>"><font color="#0d637d" size="3">Upload</font></a> </td>
