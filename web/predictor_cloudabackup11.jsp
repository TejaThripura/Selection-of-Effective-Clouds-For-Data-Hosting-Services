...
<body>
 ...
 <!-- MAIN CONTENT --> 
    ...
    <p><center><font size="5" color="white">Cloud A Back Up File Upload to Cloud B</font></center></p><br/>
    <style>
        th{
            color: green;
        }
...
String proxydate = request.getParameter("proxydate");
   ...
   <center>
           ...
           <form name="f" action="predictor_cloudabackup22.jsp" method="post" >  <center>
<table>
       ...
       <tr>
              ...
              <th><textarea type="text" name="data"  style="height:30px; width:170px"><%=fulldata%></textarea>
              </th>
        </tr>
