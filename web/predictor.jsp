...
<body>
    ...
    <li><a href="predictor.jsp" class="selected">Predictor</a></li>
 ...
 <!-- MAIN CONTENT --> 
    ...
    <center><p><font size="5" color="white">Predictor Login </font></p><br/></center>
     
    <form action="predictoract.jsp" method="post">
