...
<body>
    ...
    <li><a href="proxy_viewfiles.jsp" class="selected">Upload Files</a></li>
    <li><a href="proxy_cloudanot.jsp">Cloud A Notifications</a></li>
    <li><a href="proxy_cloudbnot.jsp">Cloud B Notifications</a></li>
    <li><a href="proxy.jsp">Logout</a></li>
 ...
 <!-- MAIN CONTENT --> 
    ...
    <p><center><font size="5" color="white">Upload to Cloud </font></center></p><br/>
    <style>
        th{
            color: green;
        }
...
String ownerdate = request.getParameter("ownerdate");
   ...
   <center>
           ...
           <form name="f" action="proxy_viewfiles2.jsp" method="post" >  <center>
<table>
   
        <tr>
            <th><font color="white" size="4">File Name </th>
              <th><input type="text" name="filename" value="<%=filename%>" readonly style="height:30px; width:170px"></input>
              </th>
        </tr>
        ...
        <tr>
              ...
              <th><input type="text" name="ownername" value="<%=ownername%>"  style="height:30px; width:170px" readonly></input>
              </th>
        </tr>
    
      <tr>
              <th><font color="white" size="4">Owner Uploaded Date</th>
              <th><input type="text" name="ownerdate" value="<%=ownerdate%>" style="height:30px; width:170px" readonly></input>
              </th>
        </tr>  
       ...
       <tr>
              <th><font color="white" size="4">Data </th>
              <th><textarea type="text" name="data" readonly style="height:30px; width:170px"><%=data%></textarea>
              </th>
        </tr>
          
              
           <tr>
              <th><font color="white" size="4">Cloud Cost for Each File </th>
              <th><input type="text"  value="Cloud A: 50    Cloud B: 60" readonly style="height:30px; width:170px; background-color: red" ></input>
              </th>
        </tr>  
              
          <tr>
              <th><font color="white" size="4">Available Space </th>
              <th><input type="text"  value="Cloud A:500GB Cloud B:400GB" style="height:30px; width:170px; background-color: red" readonly></input>
               </th>
        </tr>       
             
    
      <tr>  
               <th><font color="white" size="4">Cloud</th>
               <th><select id="s1" name="cloud" required style="width: 175px;" class="text">
