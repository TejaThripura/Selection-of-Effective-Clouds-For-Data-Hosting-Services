...
<body>
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
     <ul>
    <li><a href="cloudahome.jsp" class="selected">Home</a></li>
    <li><a href="clouda_viewfiles.jsp">Upload Files</a></li>
    <li><a href="clouda_notification.jsp">Send Notification</a></li>
...
try{ 
	Connection con = null;
        ...
        PreparedStatement pst=con.prepareStatement("select * from clouda");
...
<%
	...
	while(rs.next()){
           ...
           <td><a href="clouda_notification1.jsp?ownername=<%=rs.getString(3)%>&filename=<%=rs.getString(2)%>&data=<%=rs.getString(5).replaceAll("\\+", "%2B")%>"><font color="#0d637d" size="3">Send Notification</font></a> </td>
