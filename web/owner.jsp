...
<body>
       ...
       <script>alert('Owner Registered Successfully...!');</script>
       <%}%>
 ...
 <!-- MAIN CONTENT --> 
    ...
    <center><p><font size="5" color="white">Owner Login </font></p><br/></center>
    ...
    <br/>
    <center><a href="ownerreg.jsp"><font color="white" style="font-size: 21px">Click Here for Registration </font></a> </center>  
